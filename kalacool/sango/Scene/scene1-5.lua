...
function scene:enterScene( event )
    ...
    -- local starSystem = starSystemClass.new({fs=1,ss=2,ts=3, wp1=1,wp2=2,ct=160 })
    ...
    dog=PlayerSet.new(characterConfig.char,{x=900,y=1300})
    dog:setPlayerShow()
    ...
    local background = BackgroundSet.setBackgroundLayer(myLevel,dog,
        {{imgPath = "kalacool/sango/image/gameBackground/flappy.png",x = 40,y = 510}})
    ...
    DataCollect:addSceneCollect({senario=1,level=5})
    ----  Data Collector END  ----
