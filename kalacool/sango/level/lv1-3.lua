...
level.layers["Monster"].objects = {}
 ...
 level.layers["Monster"].objects["object15"] = EnemySet.newMonsterCannon({x=98,y=1584})
 level.layers["Monster"]:insert(level.layers["Monster"].objects["object15"].image)
 level.layers["Monster"].objects["object16"] = EnemySet.newMonsterCannon({x=1118,y=1584})
