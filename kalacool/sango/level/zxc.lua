...
level.layers["Supplement"].objects = {}
 ...
 level.layers["Monster"].objects["object16"] = EnemySet.newMonsterWarrior({x=696,y=114,xL=96,xR=1268})
 level.layers["Monster"]:insert(level.layers["Monster"].objects["object16"].image)
 level.layers["Monster"].objects["object17"] = EnemySet.newMonsterWarrior({x=796,y=114,xL=96,xR=1268})
 level.layers["Monster"]:insert(level.layers["Monster"].objects["object17"].image)
 level.layers["Monster"].objects["object18"] = EnemySet.newMonsterWarrior({x=896,y=614,xL=96,xR=1268})
 level.layers["Monster"]:insert(level.layers["Monster"].objects["object18"].image)
 level.layers["Monster"].objects["object19"] = EnemySet.newMonsterWarrior({x=996,y=614,xL=96,xR=1268})
 ...
 level.layers["Monster"].objects["object76"] = EnemySet.newMonsterWarrior({x=1436,y=1554,xL=830,xR=1986})
 level.layers["Monster"]:insert(level.layers["Monster"].objects["object76"].image)
 level.layers["Monster"].objects["object77"] = EnemySet.newMonsterWarrior({x=1536,y=1554,xL=830,xR=1986})
 level.layers["Monster"]:insert(level.layers["Monster"].objects["object77"].image)
 level.layers["Monster"].objects["object78"] = EnemySet.newMonsterWarrior({x=1636,y=1554,xL=830,xR=1986})
