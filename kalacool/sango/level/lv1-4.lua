...
level.layers["Image"].objects = {}
 ...
 level.layers["StaticWorld"].objects["object5"] = WorldSet.newhor_floor({x=3080,y=700})
 level.layers["StaticWorld"]:insert(level.layers["StaticWorld"].objects["object5"].image)
 level.layers["StaticWorld"].objects["object6"] = WorldSet.newhor_floor({x=3680,y=700})
 level.layers["StaticWorld"]:insert(level.layers["StaticWorld"].objects["object6"].image)
 level.layers["StaticWorld"].objects["object7"] = WorldSet.newhor_floor({x=4280,y=700})
 level.layers["StaticWorld"]:insert(level.layers["StaticWorld"].objects["object7"].image)
 level.layers["StaticWorld"].objects["object8"] = WorldSet.newhor_floor({x=4880,y=700})
 level.layers["StaticWorld"]:insert(level.layers["StaticWorld"].objects["object8"].image)
 level.layers["StaticWorld"].objects["object9"] = WorldSet.newhor_floor({x=5480,y=700})
 level.layers["StaticWorld"]:insert(level.layers["StaticWorld"].objects["object9"].image)
 level.layers["StaticWorld"].objects["object10"] = WorldSet.newhor_floor({x=6080,y=700})
 ...
 level.layers["StaticWorld"].objects["object92"] = WorldSet.newhor_floor({x=3080,y=1440})
 level.layers["StaticWorld"]:insert(level.layers["StaticWorld"].objects["object92"].image)
 level.layers["StaticWorld"].objects["object93"] = WorldSet.newhor_floor({x=3680,y=1440})
 level.layers["StaticWorld"]:insert(level.layers["StaticWorld"].objects["object93"].image)
 level.layers["StaticWorld"].objects["object94"] = WorldSet.newhor_floor({x=4280,y=1440})
 level.layers["StaticWorld"]:insert(level.layers["StaticWorld"].objects["object94"].image)
 level.layers["StaticWorld"].objects["object95"] = WorldSet.newhor_floor({x=4880,y=1440})
 level.layers["StaticWorld"]:insert(level.layers["StaticWorld"].objects["object95"].image)
 level.layers["StaticWorld"].objects["object96"] = WorldSet.newhor_floor({x=5480,y=1440})
 level.layers["StaticWorld"]:insert(level.layers["StaticWorld"].objects["object96"].image)
 level.layers["StaticWorld"].objects["object97"] = WorldSet.newhor_floor({x=6080,y=1440})
 ...
 level.layers["StaticWorld"].objects["object172"] = WorldSet.newM_hor_floor({x=1698,y=1276})
 level.layers["StaticWorld"]:insert(level.layers["StaticWorld"].objects["object172"].image)
 level.layers["StaticWorld"].objects["object172"].image:rotate(30)
 level.layers["Image"].objects["object173"] = display.newImage("kalacool/sango/image/sign/lv1-4/sign_powerSupply.png",1462,1186)
 level.layers["Image"]:insert(level.layers["Image"].objects["object173"])
 level.layers["InteractiveWorld"].objects["object174"] = MechanismSet.newPowerGenerator({x=1464,y=1350,key=1})
 level.layers["InteractiveWorld"]:insert(level.layers["InteractiveWorld"].objects["object174"].image)
 level.layers["InteractiveWorld"].objects["object175"] = MechanismSet.newPowerDoor({x=1720,y=1142,key=1})
 level.layers["InteractiveWorld"]:insert(level.layers["InteractiveWorld"].objects["object175"].image)
 level.layers["InteractiveWorld"].objects["object175"].image:rotate(180)
 level.layers["StaticWorld"].objects["object176"] = WorldSet.newM_hor_floor({x=1670,y=1380})
 level.layers["StaticWorld"]:insert(level.layers["StaticWorld"].objects["object176"].image)
 level.layers["StaticWorld"].objects["object177"] = WorldSet.newM_hor_floor({x=1698,y=856})
 level.layers["StaticWorld"]:insert(level.layers["StaticWorld"].objects["object177"].image)
 level.layers["StaticWorld"].objects["object177"].image:rotate(330)
 level.layers["StaticWorld"].objects["object178"] = WorldSet.newM_hor_floor({x=1670,y=760})
 level.layers["StaticWorld"]:insert(level.layers["StaticWorld"].objects["object178"].image)
 level.layers["InteractiveWorld"].objects["object179"] = MechanismSet.newPowerDoor({x=1720,y=994,key=1})
